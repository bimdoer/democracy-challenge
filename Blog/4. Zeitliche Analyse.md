...
<div markdown="0">{% include klapper-abstimmungsfrequenz.html %}</div>
...
<div markdown="0">{% include klapper-phase-fruehphase.html %}</div>

<div markdown="0">{% include klapper-phase-volatile.html %}</div>

<div markdown="0">{% include klapper-phase-konsens.html %}</div>

<div markdown="0">{% include klapper-phase-aufspaltung.html %}</div>

<div markdown="0">{% include klapper-phase-2010.html %}</div>
